...
const courseGridImage = (props) => (
  <div className="flex justify-center items-center gap-4 image cursor-pointer">
...
const customerGridDifficulty = (props) => {
  const classText = props.Difficulty == "Easy" ? "text-teal-500" :
  props.Difficulty == "Medium" ? "text-orange-500" : "text-rose-600";
  return <span className={`font-bold ${classText}`}>{props.Difficulty}</span>;
};
...
export const courseQuestionsGrid = [
  ...
  },
  {
    ...
    width: "100",
    template: customerGridDifficulty,
    textAlign: "Center",
  },
  {
    field: "Status",
