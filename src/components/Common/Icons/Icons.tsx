...
export const MapPin = ({ color, size }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      viewBox="0 0 24 24"
      strokeWidth="1.5"
      stroke={color} // Use the "color" prop to set the stroke color
      className={`w-${size} h-${size}`} // Use the "size" prop to set the width and height classes
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
...
export const Verified = ({ color, size }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const CalendarDays = ({ color, styles }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const ProfileIcon = ({ color, styles }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const SkillIcon = ({ color, styles }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
